...
import { FaImages, FaUserShield } from 'react-icons/fa6';
  ...
  return (
    ...
    >
      ...
      <div className="text-center bg-white flex gap-1 items-center font-bold border-b border-[#916131]">
        <img src="/Logo.png" alt="Admin Pakuaji Logo" className={`w-[70px] ${!isOpen && 'hidden'}`} />
        ...
        {menus.map((menu, index) => (
          <Nav.Link
            ...
            className={`flex items-center px-2 py-3 text-white text-lg transition-all duration-300 ${
              location.pathname === menu.link ? 'bg-[#613d1a]' : 'hover:bg-[#a47444]'
            }`}
          >
